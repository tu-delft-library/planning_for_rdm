...
Let's illustrate why planning for research data management is essential by looking at several examples of researchers who did not effectively manage the data for their projects:  

::::{grid} 2
:::{grid-item-card}  Scenario 1: No backups  
...
:::
:::{grid-item-card}  Scenario 2: Missing documentation 
...
::::{grid} 2
:::{grid-item-card}  Scenario 3: Redundant file naming  
...
:::
:::{grid-item-card}  Scenario 4: Late ethics application 
...
:::
::::
<p style="font-size: x-small;"><em>Scenarios 1-3 re-used and adapted from: Li, M., Marcoux, K., Nazareth, D., Nikuze, A., & Plomp, W. (2025, December). Research Data Management Guidebook for Students. Zenodo.  <a href="https://doi.org/10.5281/zenodo.15576176 "target="_blank"></em></p>
<br>
