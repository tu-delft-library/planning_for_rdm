...
<table style="border-collapse: collapse; width: 100%;">
  ...
  <tr style="background-color: #f2f2f2;">
    <th style="border: 1px solid black; padding: 10px; width: 45%;">
      Stage of Research Project Cycle
    </th>
    <th style="border: 1px solid black; padding: 10px; width: 55%;">
      Elements to consider for RDM
    </th>
  </tr>
  ...
  <tr>
    ...
    <td style="border: 1px solid black; padding: 10px; vertical-align: top;">
      <ul>
        <li>Identify in advance the research objects and research data you will be working with.</li>
        <li>Determine whether the data require ethical or legal approvals.</li>
      </ul>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style="border: 1px solid black; padding: 10px; vertical-align: top;">
      <ul>
        <li>Plan ahead where the research data will be stored.</li>
        <li>Plan what format(s) the data will be saved in.</li>
      </ul>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style="border: 1px solid black; padding: 10px; vertical-align: top;">
      <ul>
        <li>Plan how you will document your research methods.</li>
        <li>Plan how you will name and organise research artefacts throughout data collection.</li>
      </ul>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style="border: 1px solid black; padding: 10px; vertical-align: top;">
      <ul>
        <li>Plan how you will maintain a clear link between the research data, your analyses, and your results.</li>
      </ul>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td style="border: 1px solid black; padding: 10px; vertical-align: top;">
      <ul>
        <li>Plan what will happen to the research data after the project is complete.</li>
      </ul>
    </td>
  </tr>
