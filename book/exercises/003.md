...
```yaml
author: TeachBooks Team, built with [TeachBooks](https://teachbooks.io), [CC BY 4.0<img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/cc.svg" alt=""><img style="height:22px!important;margin-left:3px;vertical-align:text-bottom;" src="https://mirrors.creativecommons.org/presskit/icons/by.svg" alt="">](https://creativecommons.org/licenses/by/4.0/)
```
````
