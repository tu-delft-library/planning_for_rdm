...
## *Key question: Specifically, how will the data be collected?* 
...
- Draw a diagram of your experimental set-up and then describe in words how it will be used to collect data.  

- Make a list of tools or resources that will be required to collect the data, and then describe in more words how each tool will be used.    
...
- Data collection methodology (e.g., online survey tool used, sampling strategy, data range)
- The anonymisation process applied, including how participant identifiers were replaced and what variables were removed or generalised to prevent re-identification
- Variable transformations or recording applied after collection
- Any limitations, missing data, or known inconsistencies in the dataset
- Software and version required to open/access and process the files
