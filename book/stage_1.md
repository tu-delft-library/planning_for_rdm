...
Please note: CC licensing does not apply to software. To learn in more detail about interpreting software licenses, visit: Schlauch, Tobias - “All you need to know about Software Licenses as a RSE”. Another helpful resource is the DCC guide on software licenses 

While some data have a CC license, other data are protected by copyright. To learn more about the extent to which you can use copyrighted data, visit the TU Delft Library’s Copyright website: As a student, I want to re-use data in my multimedia/data/student paper, thesis, etc.  
